    ...
    <div className='w-full bg-rafaishop-secondary'>
      <div className='mx-auto w-10/12 max-w-5xl py-20'>
        <div className='flex flex-col items-center justify-center gap-4 text-center'>
          <h2 className='text-3xl font-bold text-white tracking-wide'>Yuk, rasakan sendiri pengalaman belanja yang mudah dan nyaman di Rafaishop!</h2>
          <p className='text-white'>Cukup klik tombol di bawah ini untuk ke halaman produk loh!</p>
          <Link href={"/products"} className='rounded-lg bg-[#FC5185] w-full md:w-auto px-14 py-3 mt-4'>
