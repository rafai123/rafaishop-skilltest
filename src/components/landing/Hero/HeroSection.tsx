...
const HeroSection = () => {
  return (
    <div className='flex flex-col justify-center gap-5 py-10 md:py-20 md:flex-row mx-auto w-10/12 max-w-5xl'>
      <div className='flex flex-col justify-center py-10 '>
        ...
        <div className='flex flex-col md:flex-row text-center gap-3 py-2'>
